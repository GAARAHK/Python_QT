...
class ControlPage(QWidget):
    ...
    def _build_loop_card(self):
        ...
        self._loop_bar.setFixedHeight(8)
    ...
    def on_disconnected(self):
        ...
        self._stop_loop_internal(False)
        self._apply_connection_state(False)
        log("串口已断开", "warning")
    ...
    def _stop_loop_internal(self, finished: bool):
...
with open('main.py', 'w', encoding='gbk') as f:
    f.write(src)
print('ok')
